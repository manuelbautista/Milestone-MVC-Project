...
namespace DCS.Common.Models
{
    public class ProjectSummaryModel
    {
        ...
        public string ProjectScopeModifiedDate { get; set; }
        public string ProjectScheduleModifiedDate { get; set; }
        public string ProjectResourceModifiedDate { get; set; }
        public string ProjectFinancialModifiedDate { get; set; }
        public string ProjectOverAllModifiedDate { get; set; }
        public string ETOPlayBookModifiedDate { get; set; }
        public string PeerReviewModifiedDate { get; set; }
        public string ProjectNameModifiedDate { get; set; }
        public string AnthemOwnerModifiedDate { get; set; }
        public string ExternalOwnerModifiedDate { get; set; }
        public string ProjectStartDateModifiedDate { get; set; }
        public string ProjectEndDateModifiedDate { get; set; }
        public string ProjectCompleteModifiedDate { get; set; }
        public string ProjectNumberModifiedDate { get; set; }
    ...
    public class ProjectSummaryDetailModel
    {
        ...
        public string ETOPlayBookName { get; set; }

        public string ProjectFundingAsk { get; set; }
        ...
        public List<ProjectDuration> ProjectDurationList
        {
            get
            {
                List<ProjectDuration> projectDurations = new List<ProjectDuration>();
                //Logic part
                int yearDiff = this.ProjectEndDate.Year - this.ProjectStartDate.Year;
                List<KeyValueObject> months = new List<KeyValueObject>();
                if (yearDiff > 0)
                {
                ...
                for (int i = 0; i < months.Count; i++)
                {
                    ...
                    objDuration.Title = GetMonthNameWithYear(months[i].Month, months[i].Year);
                    ...
                    if (this.ProjectMileStones != null && this.ProjectMileStones.Count > 0)
                    {
                        ...
                        {
                            if (months[i].Year == milestone.MileStoneDate.Year.ToString())
                            {
                                if (months[i].Month == milestone.MileStoneDate.Month)
                                {
                    ...
                    projectDurations.Add(objDuration);
                }
